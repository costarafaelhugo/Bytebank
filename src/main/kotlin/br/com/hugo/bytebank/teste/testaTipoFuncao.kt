...
fun testaFunccaoLambda() {
    ...
    val caluculaBonificacao: (salario: Double) -> Double = lambda@{ salario ->
        if (salario > 1000.0) {
            return@lambda salario + 50
        }
        salario + 100.0
    }
    println(caluculaBonificacao(1000.0))
}
...
fun soma(a: Int, b: Int, function: () -> Unit):Int{
    return a+b
}
